// Brand colors and theme constants for CCRE Portal
export const G = {
...
export const statusColor = {
  Closed:{bg:G.greenBg,text:G.green},
  "Under Contract":{bg:G.amberBg,text:G.amber},
  Active:{bg:G.blueBg,text:G.blue},
  Paid:{bg:G.greenBg,text:G.green},
  Pending:{bg:G.amberBg,text:G.amber},
};
